        ...
        <?php else: ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <?php foreach ($plottingList as $plotting): ?>
                    ...
                    <article class="bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden transition-all duration-200 hover:shadow-md hover:border-blue-200">
                        ...
                        <div class="border-t border-slate-100 bg-slate-50/60">
                            ...
                            <!-- Periode -->
                            <div class="p-4 sm:p-5 grid grid-cols-2 gap-4">
